        ...
        <div className="p-6">
          ...
          <div className="pt-5">
            <p className="text-sm text-slate-700 dark:text-slate-400 mb-4">
              ...
              <code className="text-primary">.grid-cols-*</code> and{" "}
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex">
                    <span className="px-4 inline-flex items-center min-w-fit rounded-l border border-r-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400">
                      @
                    </span>
                    <input
                      type="text"
