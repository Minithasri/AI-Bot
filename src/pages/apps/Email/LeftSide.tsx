    ...
    <div className="card min-w-80 h-full min-h-full rounded-none lg:rounded-md">
      <div data-simplebar className="h-full p-6">
        <Link
          ...
          type="button"
          className="btn bg-danger inline-flex justify-center text-white w-full"
        >
          Compose
        </Link>
        ...
        <div className="mt-6">
          <Link
            ...
            className="py-2 px-1.5 text-sm flex items-center font-bold text-danger"
          >
            <i className="ri-inbox-line me-2"></i>Inbox
            <span className="py-0.5 px-1.5 text-xs rounded bg-danger/10 text-danger ms-auto">
              {totalUnreadEmails}
            </span>
          </Link>
          <Link
            ...
            className="py-2 px-1.5 text-sm flex items-center font-medium text-gray-400 hover:text-gray-800 dark:hover:text-white"
          >
          ...
          >
            ...
            <span className="py-0.5 px-1.5 text-xs rounded bg-info/10 text-info ms-auto">32</span>
          </Link>
          <Link
            to=""
            className="py-2 px-1.5 text-sm flex items-center font-medium text-gray-400 hover:text-gray-800 dark:hover:text-white"
        ...
        <div className="mt-9">
          ...
          <div className="mt-4">
            <Link
              to=""
              className="py-2 px-1.5 text-sm font-medium flex items-center text-gray-400 hover:text-gray-800 dark:hover:text-white"
            >
        ...
        <div className="mt-16">
          <span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-sm/none font-semibold uppercase bg-gray-900/20 text-gray-900 dark:bg-gray-700 dark:text-gray-400 open:opacity-0">
            Free
          </span>
