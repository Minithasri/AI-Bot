      ...
      <div className="p-6">
        ...
        <div className="border divide-y border-collapse dark:divide-gray-700 dark:border-gray-700 rounded-md">
          <Collapse open={basicAccordion == 0} toggleCollapse={handleBasicAccordion(0)}>
            <Collapse.Toggle
              openClass="text-primary bg-primary/10"
              className="py-2 px-5 inline-flex items-center justify-between gap-x-3 w-full text-sm font-medium text-left transition text-gray-500 dark:text-gray-200"
            >
                ...
                <Collapse.Menu className="w-full overflow-hidden transition-[height] duration-300">
                  <div className="py-4 px-5">
                    <p className="text-gray-800 dark:text-gray-200">
                      ...
                      create form layouts, tables, or modal dialogs, Tailwind CSS provides
                      everything necessary to design beautiful, responsive web applications.
                      Additionally, the framework includes checkout forms, shopping carts, and
                      product views, making it the ideal choice for developing your next e-commerce
                      front-end.
                    </p>
                  </div>
                </Collapse.Menu>
    ...
    <div className="card">
      <div className="p-6">
        ...
        <div className="pt-5">
          <Collapse
            open={isOpen}
            toggleCollapse={handlerAccordion}
            className="border divide-y rounded-md dark:border-gray-700 dark:divide-gray-700"
          >
            <Collapse.Toggle
              openClass="text-primary bg-primary/10"
              className="py-2 px-5 inline-flex items-center justify-between gap-x-3 w-full text-sm font-medium text-left transition text-gray-500 dark:text-gray-200"
          ...
          <Collapse open={iconAccordion === 0} toggleCollapse={handleIconAccordion(0)}>
            <div className="rounded-md border border-gray-200 dark:border-gray-700">
              <Collapse.Toggle
                ...
                className="py-2 px-5 inline-flex items-center justify-between gap-x-3 w-full text-left font-medium transition text-gray-500 dark:text-gray-200"
              >
                <span>Accordion Item #1</span>
                <span className="ri-arrow-down-s-line text-xl block transition-all"></span>
              </Collapse.Toggle>
        ...
        <div className="pt-5 space-y-3">
          <Collapse open={noArrowAccordion === 0} toggleCollapse={handleNoArrowAccordion(0)}>
            <div className="rounded-md border border-gray-200 dark:border-gray-700">
              <Collapse.Toggle
                openClass="text-primary"
                className="py-3 px-5 inline-flex items-center justify-between gap-x-3 w-full text-left font-medium transition text-gray-500 dark:text-gray-200"
              >
                <span>Accordion Item #1</span>
              </Collapse.Toggle>
