      ...
      <div className="grid xl:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="lg:w-1/6 md:1/3 px-3">
                <img
                  src={Img3}
                  alt=""
                  className="w-52 p-1 border border-gray-200 rounded bg-slate-100"
                />
                <p className="text-info mt-2">
              ...
              <div className="lg:w-1/6 md:1/3 px-3">
                <img
                  src={avatar8}
                  alt=""
                  className="w-32 rounded-full p-1 border border-gray-200 bg-slate-100"
                />
        ...
        <div className="card p-6">
          ...
          <div className="flex flex-wrap items-end gap-3">
            ...
            <div className="relative inline-block">
              <img
                className="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800"
                src={avatar2}
                alt="Image Description"
              />
        ...
        <div className="card p-6">
          ...
          <div className="flex flex-wrap items-end gap-3">
            <div className="relative inline-block">
              <img
                className="inline-block h-8 w-8 rounded-md ring-2 ring-white dark:ring-gray-800"
                src={avatar1}
                alt="Image Description"
              />
            ...
            <div className="relative inline-block">
              <img
                className="inline-block h-9 w-9 rounded-md ring-2 ring-white dark:ring-gray-800"
                src={avatar2}
                alt="Image Description"
              />
            ...
            <div className="relative inline-block">
              <img
                className="inline-block h-12 w-12 rounded-md ring-2 ring-white dark:ring-gray-800"
                src={avatar3}
                alt="Image Description"
              />
            ...
            <div className="relative inline-block">
              <img
                className="inline-block h-16 w-16 rounded-md ring-2 ring-white dark:ring-gray-800"
                src={avatar4}
                alt="Image Description"
              />
          ...
          <div className="flex flex-wrap items-end gap-3">
            <div className="flex-shrink-0 group block">
              <div className="flex items-center">
                <img
                  className="inline-block flex-shrink-0 h-16 w-16 rounded-full"
                  src={avatar5}
                  alt="Image Description"
                />
                <div className="ms-3">
        ...
        <div className="card p-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex">
              <img
                className="inline-block h-9 w-9 rounded-full border-2 border-red-300"
                src={avatar1}
                alt="Image Description"
              />
              <img
            ...
            <div className="flex">
              <img
                className="inline-block h-12 w-12 rounded-full border-2 border-teal-500"
                src={avatar1}
                alt="Image Description"
              />
              <img
            ...
            <div className="flex">
              <img
                className="inline-block h-16 w-16 rounded-full border-2 border-purple-400"
                src={avatar1}
                alt="Image Description"
              />
              <img
        ...
        <div className="card p-6">
          ...
          <div className="flex gap-3">
            <div className="flex -space-x-2">
              <img
                className="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-800"
                src={avatar1}
                alt="Image Description"
              />
