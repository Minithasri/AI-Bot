  ...
  return (
    <>
              ...
              <Droppable droppableId="todoTasks">
                {(provided: any) => (
                  <div
                    ...
                    className="flex flex-col flex-shrink-0 w-80 border rounded-md border-gray-200 dark:border-gray-700 p-4"
                  >
      ...
      <ModalLayout
        ...
        panelClassName="min-w-[768px] mt-8 rounded-none"
        aria-hidden="true"
      >
          ...
          <div className="py-3 px-6 overflow-y-auto">
            <form onSubmit={handleSubmit(handleNewTask)}>
              <FormInput
                ...
                label="Project"
                type="select"
                containerClass="w-full space-y-1.5 mb-6"
          ...
          <div className="pointer-events-auto relative flex w-full flex-col">
            <div className="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700 pt-8">
              <h3 className="font-medium text-gray-800 dark:text-white text-lg">
                iOS App home page
                <span className="inline-flex items-center gap-1.5 p-1 rounded-md text-xs font-medium bg-danger text-white ms-3">
                  High
                </span>
              </h3>
            ...
            <div className="px-4 py-8 overflow-y-auto">
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                  ...
                  <div className="col-span-1">
                    ...
                    <div className="flex items-center">
                      <div className="-me-3">
                        <Link to="">
                          <img
                            src={avatar1}
                            alt=""
                            className="rounded-full h-8 w-8 hover:-translate-y-0.5 transition-all duration-200"
                          />
                        </Link>
                        <div
                          className="bg-slate-700 hidden px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                          role="tooltip"
                        >
                          Tosha
                      ...
                      <div className="-me-3">
                        <Link to="">
                          <div className="bg-warning text-white font-medium flex items-center justify-center rounded-full h-8 w-8 hover:-translate-y-0.5 transition-all duration-200">
                            K
                          </div>
                        </Link>
                        <div
              ...
              <Tab.Group>
                <Tab.List
                  as="nav"
                  className="flex space-x-5 border-b border-gray-300 dark:border-gray-700"
                  aria-label="Tabs"
                >
                  <Tab
                    key={"comments"}
                    type="button"
                    className={({ selected }) =>
                      `py-4 px-1 inline-flex items-center gap-2 border-b-2 -mb-px transition-all text-sm whitespace-nowrap dark:text-gray-400 hover:text-primary ${
                        selected
                          ? "font-semibold border-primary text-primary active"
                  ...
                  <Tab.Panel className="transition-all duration-300 transform">
                    ...
                    <div className="flex gap-5">
                      ...
                      <div className="w-full">
                        <h5 className="mb-2 text-gray-500 dark:text-gray-400 font-semibold">
                          Jeremy Tomlinson
                        </h5>
