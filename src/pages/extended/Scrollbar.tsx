          ...
          <div className="py-6 px-1">
            <div className="custom-scroll overflow-auto h-56 px-5">
              <div className="max-w-full">
                ...
                <p className="mt-4 text-lg text-slate-700 dark:text-slate-400">
                  Tailwind CSS is incredibly performance focused and aims to produce the smallest
                  CSS file possible by only generating the CSS you are actually using in your
                  project.
                </p>
                <p className="mt-4 text-lg text-slate-700 dark:text-slate-400">
                  Combined with minification and network compression, this usually leads to CSS
                  files that are less than 10kB, even for large projects. For example, Netflix uses
                  Tailwind for{" "}
                ...
                <p className="mt-4 text-lg text-slate-700 dark:text-slate-400">
                  ...
                  code-splitting your CSS for each page, and can instead just ship a single small
                  CSS file that’s downloaded once and cached until you redeploy your site.
                </p>
              </div>
            </div>
          </div>
            ...
            <SimpleBar className="h-56 px-6">
              <div className="prose max-w-full text-slate-700 dark:text-slate-400">
                ...
                <p>
                  ...
                  . It keeps the <strong className="dark:text-white">native</strong>
                  <code>overflow: auto</code> scroll and{" "}
                  <strong className="dark:text-white">only</strong> replace the scrollbar visual
                  appearance.
                </p>
                <h5>Design it as you want</h5>
                <p>
                  SimpleBar uses pure CSS to style the scrollbar. You can easily customize it as you
                  want! Or even have multiple style on the same page...or just keep the default
                  style ("Mac OS" scrollbar style).
                </p>
