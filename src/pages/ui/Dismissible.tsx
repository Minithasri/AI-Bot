      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div className="p-6">
              ...
              >
                ...
                <button
                  ...
                  type="button"
                  onClick={() => handleDismiss("dismiss-example")}
                >
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div
              className="card shadow-md max-w-xs relative transition-all duration-300"
              id="dismiss-card"
            >
              <div className="absolute end-2 top-2">
                <button
                  onClick={() => handleDismiss("dismiss-card")}
                  className="ms-auto h-8 w-8 rounded-full bg-gray-500/20 flex justify-center items-center "
                >
                  <i className="ri-close-line text-xl"></i>
                </button>
              </div>
