      ...
      {(emails || []).map((email, idx) => {
        return (
          <div
            ...
            } group relative px-4 py-3 transition-all duration-500 hover:bg-light/50 overflow-hidden dark:hover:bg-light/5`}
          >
            <div className="flex items-center h-full">
              ...
              <i
                className={`ri-star-line mx-5 text-lg ${email.is_important ? "text-warning" : ""}`}
              ></i>
