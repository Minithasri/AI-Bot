    ...
    <div className="card">
      <div className="p-6">
        ...
        <FormInput
          name="select2"
          type="select"
          className="form-select mb-3 form-select-lg"
          key="select-2"
        >
          <option defaultValue="selected">Open this select menu</option>
          <option value="1">One</option>
        ...
        <div className="flex items-center mb-3">
          <label
            className="btn border border-gray-200 dark:border-gray-600 rounded-e-none"
          ...
          <FormInput
            name="select4"
            type="select"
            className="form-select border-s-0 rounded-s-none"
        ...
        <div className="flex">
          <FormInput
            name="select4"
            type="select"
            className="form-select border-e-0 rounded-e-none"
            containerClass="w-full"
            key="select-4"
          >
            <option defaultValue="selected">Choose...</option>
          ...
          <button
            className="btn border border-gray-200 dark:border-gray-600 rounded-s-none"
            type="button"
          >
            Button
          </button>
