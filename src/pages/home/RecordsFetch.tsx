...
const RecordsFetch: React.FC = () => {
  ...
  //   // ------------------------------
  //   // SPLIT INTO UPDATED & PENDING
  //   // ------------------------------
  //   const updated = merged.filter((row) => editableCols.some((c) => row[c] && row[c] !== ""));
      ...
      <div className="max-w-[95vw] mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="border border-gray-200 px-6 py-4 flex items-center justify-between">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className="flex gap-4 items-center">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl ${
                    activeTab === "UPDATED" ? "bg-purple-600 text-white" : "bg-gray-200"
                  }`}
                >
          ...
          <div className="flex items-center gap-4">
            <div>
              Total Records: <span className="font-bold text-purple-600">{totalRecords}</span>
            </div>
