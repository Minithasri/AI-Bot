    ...
    <>
      <AuthLayout2 title="" starterClass bottomLinks={<BottomLink />}>
        <div className="text-center">
          ...
          <h4 className="text-dark/70 text-center text-lg font-bold dark:text-light/80 mb-2 mt-9">
            Please check your email
          </h4>
          <p className="text-gray-400 mb-9">
            A email has been send to youremail@domain.com. Please check for an email from company
