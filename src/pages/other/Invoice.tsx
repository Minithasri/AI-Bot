          ...
          <div className="mb-14">
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="col-span-1">
                ...
                <p className="text-xs">
                  Please find below a cost-breakdown for the recent work completed. Please make
                  payment at your earliest convenience, and do not hesitate to contact me with any
                  questions.
                </p>
              </div>
                ...
                <div className="flex sm:justify-end space-y-2">
                  <div className="grid gap-3">
                    <div className="grid grid-cols-4 gap-x-3">
                      <h6 className="col-span-2 font-semibold text-gray-500 dark:text-gray-200">
                        Order Date:
                      </h6>
                    ...
                    <div className="grid grid-cols-4 gap-x-3">
                      ...
                      <p className="col-span-2 sm:text-end text-gray-400">
                        <span className="inline-flex items-center px-1 rounded-full text-xs font-medium bg-success text-white">
                          Paid
                        </span>
                      </p>
                    </div>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="col-span-1">
                ...
                <address className="not-italic">
                  Lynne K. Higby <br /> 795 Folsom Ave, Suite 600 <br /> San Francisco, CA 94107{" "}
                  <br /> P: (123) 456-7890{" "}
                </address>
              </div>
              ...
              <div className="col-span-1">
                ...
                <address className="not-italic">
                  Tosha Minner <br /> 795 Folsom Ave, Suite 600 <br /> San Francisco, CA 94107{" "}
                  <br /> P: (123) 456-7890{" "}
                </address>
              </div>
                    ...
                    <table className="min-w-full">
                      <thead className="border-t border-b py-3 bg-gray-100 border-gray-200 dark:border-gray-600">
                        <tr>
                          ...
                          <th
                            scope="col"
                            className="px-6 py-2 whitespace-nowrap text-right font-semibold text-gray-500"
                          >
                            Total
                          </th>
                        </tr>
            ...
            <div className="col-span-1">
              <div className="flex sm:justify-end space-y-2">
                <div className="grid gap-3">
                  ...
                  <div className="grid grid-cols-4 gap-x-3">
                    <h6 className="col-span-5 sm:text-xl text-lg font-medium text-gray-500 dark:text-gray-200">
                      $4635.00 USD
                    </h6>
                  </div>
                </div>
