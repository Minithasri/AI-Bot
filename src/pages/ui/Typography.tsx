      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div className="space-y-4">
              <p className="text-3xl bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">
                The quick brown fox jumps over the lazy dog.
              </p>
              <p className="text-3xl bg-gradient-to-l from-primary to-info bg-clip-text font-semibold text-transparent">
                The quick brown fox jumps over the lazy dog.
              </p>
              <p className="text-3xl bg-gradient-to-r from-danger to-success bg-clip-text font-semibold text-transparent">
                The quick brown fox jumps over the lazy dog.
              </p>
              <p className="text-3xl bg-gradient-to-r from-fuchsia-500 to-pink-500 bg-clip-text font-semibold text-transparent">
                The quick brown fox jumps over the lazy dog.
              </p>
            </div>
          </div>
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div className="space-y-4">
              <h1 className="text-primary/90 text-lg">
                The quick brown fox jumps over the lazy dog.
              </h1>
              <h1 className="text-primary/75 text-lg">
                The quick brown fox jumps over the lazy dog.
              </h1>
              <h1 className="text-primary/50 text-lg">
                The quick brown fox jumps over the lazy dog.
              </h1>
              <h1 className="text-primary/25 text-lg">
                The quick brown fox jumps over the lazy dog.
              </h1>
              <h1 className="text-primary/10 text-lg">
                The quick brown fox jumps over the lazy dog.
              </h1>
            </div>
          </div>
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div className="space-y-4">
              <p className="text-lg underline decoration-primary">
                The quick brown fox jumps over the lazy dog.
              </p>
              <p className="text-lg overline decoration-success decoration-2">
                The quick brown fox jumps over the lazy dog.
              </p>
        ...
        <div className="card">
          <div className="p-6">
            ...
            <div className="space-y-4">
              <p className="text-lg underline decoration-solid">
                The quick brown fox jumps over the lazy dog.
              </p>
              <p className="text-lg underline decoration-double">
                The quick brown fox jumps over the lazy dog.
              </p>
