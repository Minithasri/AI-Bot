  ...
  return (
    <div className="card">
      ...
      <div className="p-6">
        ...
        <p className="mt-1 text-gray-800 dark:text-gray-400 mb-4">
  ...
  return (
    <div className="card">
      <div className="p-6">
        ...
        <p className="mt-1 text-gray-800 dark:text-gray-400 mb-4 pt-6">
      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6">
        ...
        {(colors || []).map((color, idx) => (
          <div key={idx} className={`card bg-${color}`}>
            <div className="p-6">
              <p className="mt-1 text-white mb-4">
        ...
        {(CardGroupDetails || []).map((item, idx) => {
          return (
            <div key={idx} className="card sm:rounded-none sm:rounded-s-md h-full">
              <img
                className="w-full h-auto sm:rounded-tl-md sm:rounded-none rounded-t-md"
                src={item.image}
