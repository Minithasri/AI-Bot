              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {(records || []).map((record, idx) => {
                    return (
                      <tr key={idx}>
                        <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-gray-200">
                          {record.name}
                        </td>
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-start text-gray-500 dark:text-gray-200">
                          {record.country}
                        </td>
                      </tr>
                    );
                  ...
                  {(records || []).map((record, idx) => {
                    return (
                      ...
                      >
                        <th
                          scope="row"
                          className="flex items-center gap-2 px-4 py-4 text-gray-900 whitespace-nowrap dark:text-white"
                        >
                          <img
                            ...
                            alt="Jese image"
                          />
                          <div className="whitespace-nowrap text-sm font-medium text-gray-500 dark:text-gray-200">
                            {record.name}
                          </div>
                        </th>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">
                      ...
                      <tr key={idx}>
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">
                          <div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                            <div
                              className={`flex flex-col justify-center overflow-hidden bg-${record.variant}`}
                              role="progressbar"
                  ...
                  {(expandablerecords || []).slice(0, 4).map((record, idx) => {
                    return (
                      <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-gray-900">
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">
                          <span className="text-xs text-white bg-primary rounded-md px-1 py-0.5">
                            {record.Quantity} Pcs
                          </span>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-start text-gray-500 dark:text-gray-200">
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead>
                  <tr>
                    <th
                      scope="col"
                      className="px-2 py-2 text-start text-sm font-medium text-gray-500"
                    >
                      Product
                    </th>
                    <th
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {(expandablerecords || []).map((record, idx) => {
                    return (
                      <tr key={idx}>
                        <td className="px-2 py-2 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-gray-200">
                          {record.product}
                        </td>
                        ...
                        <td className="px-2 py-2 whitespace-nowrap text-start text-gray-500 dark:text-gray-200">
                          ${record.Amount}
                        </td>
                      </tr>
                    );
          ...
          <table className="border-collapse min-w-full border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm shadow-sm">
            <thead className="bg-slate-50 dark:bg-slate-700">
              <tr>
                ...
                <th className="border border-slate-300 dark:border-slate-600 font-semibold px-4 py-4 text-slate-900 dark:text-slate-200 text-center">
                  Action
                </th>
              </tr>
            </thead>
      ...
      <div className="p-6">
        ...
        <div className="relative overflow-auto">
          <table className="border-collapse min-w-full border border-primary dark:border-slate-600 bg-white dark:bg-slate-800 text-sm shadow-sm">
            <thead className="bg-slate-50 dark:bg-slate-700">
              <tr>
                <th className="border border-primary dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-start">
                  User
                </th>
                <th className="border border-primary dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-start">
                  Account No.
                ...
                <th className="border border-primary dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-center">
                  Action
                </th>
              </tr>
            </thead>
              ...
              {(records || []).map((record, idx) => {
                return (
                  <tr key={idx}>
                    ...
                    <td className="border border-primary dark:border-slate-700 px-4 py-4 text-slate-500 dark:text-slate-400">
                      {record.accountNo}
                    </td>
                    <td className="border border-primary dark:border-slate-700 px-4 py-4 text-slate-500 dark:text-slate-400">
                      {record.dob}
                  ...
                  {(records || []).map((record, idx) => {
                    return (
                      <tr key={idx}>
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-start text-white">
                          {record.country}
                        </td>
                      </tr>
                    );
