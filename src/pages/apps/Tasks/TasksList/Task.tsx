    ...
    <div className="card p-6 xl:rounded-none xl:m-0 m-6">
      <div className="dropdown float-right h-4">
        ...
        >
          <div className="min-w-40 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-md py-1">
            <Link
              className="flex items-center py-1.5 px-4 text-sm text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
              to=""
            >
            ...
            <Link
              className="flex items-center py-1.5 px-4 text-sm text-danger hover:bg-slate-100 dark:hover:bg-gray-700"
              to=""
            >
      ...
      <div className="">
        <div className="w-auto">
          <h4 className="text-base mb-2.5 font-semibold text-gray-500 dark:text-gray-300">
            {task.title}
          </h4>
            ...
            <div className="sm:w-1/2 px-3">
              ...
              <div className="flex items-center">
                <img
                  ...
                  className="h-6 rounded-full me-3"
                />
                <div>
          ...
          {task.attachments.map((file, idx) => {
            ...
            return (
              <div
                key={idx}
                className="card mb-3 border shadow-none border-gray-300 dark:border-gray-700"
              >
                <div className="p-1.5">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-auto">
                        <div className="w-12 h-12">
                          <span className="h-full w-full inline-flex items-center justify-center bg-primary text-white font-semibold rounded">
                            {ext.toUpperCase()}
                          </span>
                        </div>
                      </div>
                ...
                <React.Fragment key={idx}>
                  <div className="flex mt-6 p-1.5">
                    <img
                      ...
                      className="rounded-full me-3 h-9"
                      alt={comment.author}
                    />
                    <div className="w-full">
            ...
            <div className="w-full">
              <div className="border rounded border-gray-300 dark:border-gray-700">
                <form action="#" className="">
                  <textarea
                    rows={3}
                    className="form-input text-gray-400 border-0 resize-none placeholder:text-gray-400"
                  ...
                  <div className="p-2 bg-gray-400/10 dark:">
                    <div className="flex items-center gap-2">
                      <Link
                        to="#"
                        className="btn btn-sm bg-light dark:bg-gray-600 text-gray-950 dark:text-white"
                      >
