  ...
  return (
    <div className="card">
      <div className="p-6">
        ...
        <button
          className="bg-primary text-white hover:bg-primary-600 py-2 px-4 rounded transition-all"
          onClick={handlerOffcanvas}
        >
          Open Offcanvas
        </button>
        <OffcanvasLayout
          sizeClassName="max-w-xs w-full"
          open={open}
          placement="start"
          toggleOffcanvas={handlerOffcanvas}
        >
          <div className="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
            ...
            <button
              className="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-700  text-sm dark:text-gray-500 dark:hover:text-gray-400"
              type="button"
            >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <OffcanvasLayout
            ...
            placement="start"
            open={left}
            toggleOffcanvas={handlerLeftOffcanvas}
          >
            <div className="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
              <h3 className="font-medium">Offcanvas title</h3>
              <button
          ...
          <OffcanvasLayout
            sizeClassName="max-h-40 h-full w-full"
            placement="top"
            open={top}
            toggleOffcanvas={handlerTopOffcanvas}
          >
            <div className="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
              <h3 className="font-medium">Offcanvas title</h3>
              <button
          ...
          <OffcanvasLayout
            open={right}
            sizeClassName="h-full max-w-xs w-full"
            toggleOffcanvas={handlerRightOffcanvas}
          >
            <div className="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
              <h3 className="font-medium">Offcanvas title</h3>
              <button
          ...
          <OffcanvasLayout
            ...
            open={bottom}
            sizeClassName="max-h-40 h-full w-full"
            toggleOffcanvas={handlerBottomOffcanvas}
          >
            <div className="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
              <h3 className="font-medium">Offcanvas title</h3>
              <button
