      ...
      <div className="card p-6 h-full min-h-full lg:rounded-md rounded-none">
        <div className="relative">
          <PopoverLayout
            ...
            togglerClass="btn bg-success inline-flex justify-center text-white w-full"
          >
        ...
        <div className="mt-5">
          <Link
            to=""
            className="py-2 px-1.5 transition-all text-gray-400 flex items-center hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300"
          >
