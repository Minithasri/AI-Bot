                ...
                <table className="min-w-full">
                  <thead className="bg-light/40 border-t border-b dark:bg-slate-700/30 border-gray-200 dark:border-gray-700">
                    <tr className="text-gray-800 dark:text-gray-300">
                      <th
                        scope="col"
                        className="text-gray-500 dark:text-gray-400 p-3.5 text-sm text-start font-semibold min-w-40"
                      >
                        File Name
                      </th>
                      <th
                      ...
                      <th
                        scope="col"
                        className="text-gray-500 dark:text-gray-400 p-3.5 text-sm text-start font-semibold min-w-24"
                      >
                        File Size
                      </th>
                      <th
                        scope="col"
                        className="text-gray-500 dark:text-gray-400 p-3.5 text-sm text-start font-semibold min-w-32"
                      >
                        Owner
                      </th>
                      <th
                      ...
                      <th
                        scope="col"
                        className="text-gray-500 dark:text-gray-400 p-3.5 text-sm text-start font-semibold"
                      >
                        Action
                      </th>
                    </tr>
                        ...
                        <tr key={idx}>
                              ...
                              {(file.members || []).map((member, idx) => {
                                return (
                                  <div className="h-8 w-8 group" key={idx}>
                                    <img
                                      className="inline-block h-full w-full rounded-full hover:-translate-y-0.5 transition-all duration-200"
                                      src={member.image}
                                      alt="Image Description"
                                      id={`tooltip1-${idx + 1 + file.name}`}
                                    />
                                    <Tooltip
                                      place="top"
                                      content={member.name}
                                      anchorId={`tooltip1-${idx + 1 + file.name}`}
                                    />
                                  </div>
                                );
                              })}
                          ...
                          <td className="p-3.5">
                            <PopoverLayout
                              ...
                              togglerClass="btn bg-light px-1.5 dark:bg-slate-700"
                            >
                              <div className="min-w-40 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-md py-1">
                                {(actionMenuItems || []).map((item, idx) => {
                                  return (
                                    <Link
                                      key={idx}
                                      className="flex w-max items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                      to=""
                                    >
