      ...
      <div className="flex flex-wrap items-center gap-3">
        {(colors || []).map((color, idx) => (
          <button
            key={idx}
            type="button"
            className={`${color === "light" ? "text-dark" : "text-white"} btn bg-${color}`}
          >
      ...
      <div className="flex flex-wrap items-center gap-3">
        {(colors || []).slice(0, 6).map((color, idx) => (
          <button
            key={idx}
            type="button"
            className={`btn border-${color} text-${color} hover:bg-${color} hover:text-white`}
          >
            {color.charAt(0).toUpperCase() + color.slice(1)}
          </button>
        ))}
        ...
        <button
          type="button"
          className="btn border-light text-light hover:bg-light hover:text-gray-800 dark:text-slate-200"
        >
          Light
        </button>
        <button
          type="button"
          className="btn border-dark text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white"
        >
          Dark
        </button>
      </div>
  ...
  return (
    <div className="card p-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          type="button"
          className="btn bg-light text-slate-900 dark:text-slate-200 rounded-full"
        >
          Light
        </button>
      ...
      <div className="flex flex-wrap items-center gap-3">
        {(colors || []).slice(0, 6).map((color, idx) => (
          <button
            key={idx}
            type="button"
            className={`btn rounded-full border border-${color} text-${color} hover:bg-${color} hover:text-white`}
          >
            {color.charAt(0).toUpperCase() + color.slice(1)}
          </button>
        ))}
        ...
        <button
          type="button"
          className="btn rounded-full border-light text-light hover:bg-light hover:text-gray-800 dark:text-slate-200"
        >
          Light
        </button>
        <button
          type="button"
          className="btn rounded-full border border-dark text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white"
        >
          Dark
        </button>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        {(colors || []).slice(0, 6).map((color, idx) => (
          <button
            key={idx}
            type="button"
            className={`btn bg-${color}/25 text-${color} hover:bg-${color} hover:text-white`}
          >
            {color.charAt(0).toUpperCase() + color.slice(1)}
          </button>
        ))}
        <button
          type="button"
          className="btn bg-dark/25 text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white"
        >
          Dark
        </button>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        {(colors || []).slice(0, 6).map((color, idx) => (
          <button
            key={idx}
            type="button"
            className={`btn bg-${color}/25 text-${color} hover:bg-${color} rounded-full hover:text-white`}
          >
            {color.charAt(0).toUpperCase() + color.slice(1)}
          </button>
        ))}
        <button
          type="button"
          className="btn rounded-full bg-dark/25 text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white"
        >
          Dark
        </button>
      </div>
  ...
  return (
    <div className="card p-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          type="button"
          className="btn rounded border border-success text-success hover:bg-success hover:text-white"
        >
        ...
        <button
          type="button"
          className="btn rounded border border-danger text-danger hover:bg-danger hover:text-white"
        >
    ...
    <div className="card p-6">
      ...
      <div className="">
        <div className="inline-flex rounded-md shadow-sm">
          <button
            type="button"
            className="btn bg-light first:rounded-l-lg first:ml-0 last:rounded-r-lg transition-all"
          >
            Years
          </button>
          <button
