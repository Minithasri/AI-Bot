        ...
        <div className="flex flex-wrap gap-3">
          {(directions || []).map((direction, idx) => {
            return (
              <div key={idx}>
                <Tippy
                  content={`Popover on ${direction.charAt(0).toUpperCase() + direction.slice(1)}`}
                  trigger="click"
                  placement={direction}
                >
            ...
            <Tippy
              ...
              content={
                <div className="bg-white border border-gray-100 shadow-md rounded-md dark:bg-gray-800 dark:border-gray-700">
                  <div className="px-4 py-3 border-b dark:border-gray-700 text-dark dark:text-gray-300">
                    Popover title
                  </div>
          ...
          <div>
            <Tippy
              ...
              content={
                <div className="z-50">
                  <div
                    className="max-w-xs bg-white border border-gray-100 text-left rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700"
                    role="tooltip"
                  >
