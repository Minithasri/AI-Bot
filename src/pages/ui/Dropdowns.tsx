      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2">
          <div className="">
            ...
            >
              <div className="min-w-[10rem] z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-md my-1">
                <Link
                  className="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-light hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                  to="#"
                >
                  Action
                </Link>
          ...
          <PopoverLayout
            ...
            togglerClass="btn bg-secondary text-sm text-white"
          >
            <div className="min-w-[10rem] z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-md my-1">
              <Link
                className="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-light hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
          ...
          {(alignments || []).map((align, idx) => {
            return (
              <PopoverLayout
                key={idx}
                placement={align}
                toggler={<AlignmentToggle align={align.charAt(0).toUpperCase() + align.slice(1)} />}
                togglerClass="btn bg-light dark:bg-gray-700 dark:text-white text-sm text-gray-800"
              >
                <div className="min-w-[10rem] z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-md my-1">
                  <Link
        ...
        <div className="flex flex-wrap gap-2">
          {(colors || []).map((color, idx) => {
            return (
              <PopoverLayout
                key={idx}
                toggler={<PopoverToggle name={color} />}
                togglerClass={`btn bg-${color} text-sm text-white`}
              >
                <div className="min-w-[10rem] z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-md my-1">
                  <Link
                    className="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-light hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
          ...
          {(colors || []).map((color, idx) => {
            return (
              <React.Fragment key={idx}>
                <div className="flex">
                  <button className={`btn bg-${color} text-white rounded-e-none`}>
                    {color.charAt(0).toUpperCase() + color.slice(1)}
                  </button>
                  <PopoverLayout
                    toggler={<i className="ri-arrow-down-s-fill" />}
                    togglerClass={`btn bg-${color} text-white px-2 rounded-s-none relative after:content-[''] after:absolute after:inset-0 after:bg-black/10`}
                  >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {(sizes || []).map((item, idx) => {
            return (
              <PopoverLayout
                toggler={<PopoverToggle name={item.name} />}
                key={idx}
                togglerClass={`btn btn-${item.size} bg-light text-sm text-gray-800`}
              >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            <div
              id="dropdown-target"
              className="bg-white  shadow rounded-md0 border py-1 my-1 dark:bg-gray-800 dark:border-gray-700"
            >
              <div className="relative">
                <PopoverLayout
                  placement="right-end"
                  toggler={<PopoverToggle2 />}
                  togglerClass="flex items-center justify-between py-1.5 px-5 text-sm text-gray-500 hover:bg-light hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 cursor-pointer w-full"
                >
              ...
              <div className="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-light hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                <div className="flex">
                  <input
                    type="radio"
                    name="default-radio"
                    className="shrink-0 form-radio rounded"
                    id="default-radio"
                  />
                  <label
            ...
            <div className="bg-white w-max shadow rounded border py-1 dark:bg-gray-800 dark:border-gray-700">
              <div className="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-light hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                <div className="flex">
                  <input
                    type="checkbox"
                    className="shrink-0 form-checkbox rounded"
                    id="default-checkbox"
                  />
                  <label
            ...
            <div className="bg-white w-max shadow rounded border p-5 dark:bg-gray-800 dark:border-gray-700">
              <form>
                <div className="mb-3">
                  ...
                  <small
                    id="emailHelp"
                    className="form-text text-sm text-slate-700 dark:text-slate-400"
                  >
