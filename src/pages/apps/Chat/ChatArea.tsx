            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12">
                  <span className="inline-flex items-center justify-center h-full w-full bg-primary text-white rounded">
                    .ZIP
                  </span>
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-gray-400 text-xs flex items-center">
                    <small className="ri-checkbox-blank-circle-fill text-danger me-1"></small>{" "}
                    Offline
                  </p>
                </div>
              </div>
              ...
              <form name="chat-form" noValidate onSubmit={handleSubmit(sendChatMessage)}>
                <div className="flex gap-2">
                  <FormInput
                    ...
                    className="form-input border-none bg-white dark:bg-gray-800 placeholder:text-slate-400"
                  ...
                  <div className="w-auto">
                    <div className="flex gap-1">
                      <Link
                        to="#"
                        className="btn bg-light text-gray-800 hover:bg-dark/20 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-light/20"
                      >
