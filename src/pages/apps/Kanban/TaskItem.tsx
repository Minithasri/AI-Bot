    ...
    <>
      <div className="p-6">
        ...
        <h5 onClick={toggleDescriptionModal} className="my-2">
          <span className="text-base text-gray-700 dark:text-slate-400 font-medium">
            {task.title}
          </span>
        </h5>
              ...
              <Tippy content={avatar.title} key={idx}>
                <div className="-me-3">
                  {avatar.isImage ? (
                    ...
                    <div
                      className={`${avatar.textBg} font-medium flex items-center justify-center rounded-full h-8 w-8 hover:-translate-y-0.5 transition-all duration-200`}
                    >
                      {avatar.image}
                    </div>
                  )}
