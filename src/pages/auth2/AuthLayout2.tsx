      ...
      <div className="bg-white lg:max-w-[480px] z-10 p-12 relative w-full h-full border-t-[3px] border-primary dark:bg-gray-800">
        <div className="flex flex-col h-full gap-4">
          ...
          <div className={`my-auto ${starterClass ? "text-center" : ""}`}>
            {pageImage && (
              <img src={pageImage} alt="" className="rounded-full shadow h-16 mx-auto" />
            )}

            <h4
              className={`text-dark/70 text-lg font-semibold dark:text-light/80 mb-2 ${
                pageImage ? "mt-6" : ""
              }`}
            >
              {title}
              ...
              <div className="text-center mt-9">
                ...
                <ul className="inline-flex gap-2">
                  <li className="">
                    <Link
                      to=""
                      className="rounded-full border-2 border-primary text-primary w-8 h-8 inline-flex items-center justify-center"
                    >
                  ...
                  <li className="">
                    <Link
                      to=""
                      className="rounded-full border-2 border-danger text-danger w-8 h-8 inline-flex items-center justify-center"
                    >
                  ...
                  <li className="">
                    <Link
                      to=""
                      className="rounded-full border-2 border-info text-info w-8 h-8 inline-flex items-center justify-center"
                    >
                  ...
                  <li className="">
                    <Link
                      to=""
                      className="rounded-full border-2 border-secondary text-secondary w-8 h-8 inline-flex items-center justify-center"
                    >
                ...
                >
                  <SwiperSlide>
                    <div className="swiper-slide-content">
                      ...
                      <p className="text-lg text-white mb-5">
                        <i className="ri-double-quotes-l"></i> Everything you need is in this
                  ...
                  <SwiperSlide>
                    <div className="swiper-slide-content">
                      ...
                      <p className="text-lg text-white mb-5">
                        <i className="ri-double-quotes-l"></i> Pretty nice theme, hoping you guys
                  ...
                  <SwiperSlide>
                    <div className="swiper-slide-content">
                      ...
                      <p className="text-lg text-white mb-5">
                        <i className="ri-double-quotes-l"></i> This is a great product, helped us a
