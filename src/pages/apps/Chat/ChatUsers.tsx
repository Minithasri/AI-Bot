        ...
        <div className="flex justify-between mb-6">
          ...
          <PopoverLayout placement="bottom-end" toggler={<PopoverToggle />} togglerClass="">
            <div className="min-w-40 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-md py-1 mt-1">
              <Link
                className="flex items-center py-1.5 px-5 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                to=""
              >
              ...
              <Link
                className="flex items-center py-1.5 px-5 text-sm font-medium text-danger hover:bg-gray-100 dark:hover:bg-gray-700"
                to=""
              >
          ...
          <form>
            <div className="relative flex rounded-md">
              <input
                ...
                className="form-input form-input-light ps-9"
                  ...
                  <div className="flex items-center gap-2 py-3 px-6">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>
                          {user.totalUnread !== 0 && (
                            <span className="px-1 py-0.5 text-xs rounded-full bg-danger/25 text-danger">
                              {user.totalUnread}
                            </span>
                          )}
                        </span>
