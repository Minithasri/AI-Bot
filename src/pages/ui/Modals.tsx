        ...
        <div className="flex flex-wrap gap-3">
          {(sizes || []).map((size, idx) => {
            return (
              <div key={idx}>
                <button
                  className={`btn bg-${size.variant} text-white`}
                  type="button"
                ...
                <ModalLayout
                  showModal={isModalOpen === idx}
                  toggleModal={handleModal(idx)}
                  panelClassName={size.width}
                ...
                >
                  <div className="duration-300 ease-in-out transition-all m-3 sm:mx-auto flex flex-col bg-white shadow-sm rounded dark:bg-gray-800">
                    ...
                    <div
                      className={`${
                        size.name === "Scrollable Modal" ? "max-h-80" : ""
                      } p-4 overflow-y-auto`}
                    >
          ...
          {(modalbasedAlert || []).map((item, idx) => {
            return (
              <React.Fragment key={idx}>
                <button
                  className={`btn bg-${item.variant} text-white`}
                  onClick={handleModal(idx)}
                  type="button"
                >
                ...
                >
                  <div
                    className={`duration-300 ease-in-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-${item.variant} shadow-sm rounded`}
                  >
            ...
            return (
              <div key={idx}>
                ...
                <ModalLayout
                  showModal={isModalOpen === idx}
                  toggleModal={handleModal(idx)}
                  panelClassName="sm:max-w-lg mt-3"
                  placement="justify-center items-start"
                >
                  <div className="duration-300 ease-in-out transition-all sm:max-w-lg  flex flex-col bg-white shadow-sm rounded dark:bg-gray-800 dark:border-gray-700">
                    <div
                      className={`flex justify-between items-center py-2.5 px-4 ${color} dark:border-gray-700`}
                    >
                      ...
                      >
                        <i
                          className="ri-close-line text-2xl text-white"
                          onClick={handleModal(idx)}
                        ></i>
                      </button>
                    </div>
                    <div className="p-4 overflow-y-auto">
                      <h5 className="mb-2.5 text-base">
                        {color.charAt(3).toUpperCase() + color.slice(4)} Background
                      </h5>
                      <p className="text-sm mb-4">
                        Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus
                        ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur
              ...
              <div key={idx}>
                ...
                >
                  <div className="duration-300 ease-in-out transition-all  m-3 sm:mx-auto flex flex-col bg-white shadow-sm rounded dark:bg-gray-800 dark:border-gray-700">
                    <div
                      className={`flex justify-between items-center py-2.5 px-4 ${colors2[idx]} dark:border-gray-700`}
                    >
                      <h3 className="font-medium text-white text-lg">Modal Title</h3>
                      <button
                        className="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 dark:text-gray-200"
                    ...
                    <div
                      className={`flex justify-end items-center gap-2 p-4 border-t ${color} border-white/5`}
                    >
                      <button
                        className="btn bg-light text-gray-800 transition-all"
                        onClick={handleModal(idx)}
        ...
        <div>
          ...
          >
            <div className="duration-300 ease-in-out transition-all m-3 my-0 sm:mx-auto flex flex-col bg-white shadow-sm rounded dark:bg-gray-800">
              ...
              <div className="flex justify-end items-center gap-2 p-4 border-t dark:border-slate-700">
                <button
                  className="btn bg-primary text-white transition-all"
