...
const Register2 = () => {
  return (
    <>
      <AuthLayout2
        title="Free Sign Up"
        helpText="EnDon't have an account? Create your account, it takes less than a minute"
      ...
      >
        <VerticalForm onSubmit={() => null}>
          ...
          <FormInput
            label="Remember me"
            labelClassName="ms-2 text-sm font-medium"
            type="checkbox"
            name="checkbox"
            className="form-checkbox rounded text-primary"
            containerClass={"mb-6"}
            labelContainerClassName="flex items-center"
          />
