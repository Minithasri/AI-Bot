                  ...
                  <div className="flex items-center gap-3">
                    <div className="">
                      <div className="w-12 h-12">
                        <span
                          className={`${
                            file.variant ? `text-${file.variant}` : "text-secondary"
                          } inline-flex items-center justify-center h-full w-full bg-light rounded dark:bg-slate-700 dark:text-slate-400`}
                        >
