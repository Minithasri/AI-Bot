  ...
  return (
    <>
      ...
      <div className="lg:flex w-full gap-2">
        {width >= 1024 ? (
          <div
            className="lg:block inset-y-0 start-0 transform h-ful min-h-full min-w-72 lg:z-0 z-50 fixed lg:static lg:translate-x-0 -translate-x-full transition-all duration-300 lg:rtl:-translate-x-0 rtl:translate-x-full"
            tabIndex={-1}
          >
            <LeftSide
          ...
          <OffcanvasLayout
            open={leftPanelOpen}
            toggleOffcanvas={handleLeftPanel}
            placement="start"
            sizeClassName="w-80 max-w-[24rem]"
          >
            <LeftSide
              totalUnreadEmails={totalUnreadEmails}
              toggleComposeModal={toggleComposeModal}
        ...
        <div className="card p-6 min-w-auto">
          <div className="flex flex-wrap items-center gap-2">
            <div className="lg:hidden block">
              <button
                className="inline-flex items-center justify-center text-gray-700 border border-gray-300 rounded shadow hover:bg-slate-100 dark:text-gray-400 hover:dark:bg-gray-800 dark:border-gray-700 transition h-9 w-9 duration-100"
            ...
            <div className="inline-flex">
              <button
                type="button"
                className="btn bg-secondary/90 text-white rounded-e-none hover:bg-secondary"
              >
                <i className="ri-inbox-archive-line text-base"></i>
              </button>
              <button
                type="button"
                className="btn bg-secondary/90 text-white rounded-none hover:bg-secondary"
              >
                <i className="ri-spam-2-line text-base"></i>
              </button>
              <button
                type="button"
                className="btn bg-secondary/90 text-white rounded-s-none hover:bg-secondary"
              >
            ...
            <div className="relative rounded inline-flex align-middle">
              <PopoverLayout
                ...
                togglerClass="btn bg-secondary/90 text-white rounded hover:bg-secondary"
              >
                <div className="min-w-40 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-md py-1 mt-1">
                  <span className="flex items-center py-1.5 px-3.5 text-sm text-gray-500 dark:text-gray-400">
                    Move to:
                  </span>
                  <Link
          ...
          <div className="mt-6">
            ...
            <p className="mb-4 text-sm/normal">
              Clicking ‘Order Service’ on the right-hand side of the above page will present you
              with an order page. This service has the following Briefing Guidelines that will need
              to be filled before placing your order:
            </p>
            <ol className="mb-4 block list-decimal ps-10">
              ...
              <li>
                Do you have any preference or specific thing you would like to change or improve on
                your item page?{" "}
              </li>
              <li>
                Do you want to include your item's or your provider's logo on the page? if yes,
                please send it to me in vector format (Ai or EPS){" "}
              </li>
              <li>Please provide me with the copy or text to display</li>
            </ol>
            <p className="mb-4 text-sm/normal">
              Filling in this form with the above information will ensure that they will be able to
              start work quickly.
            </p>
            <p className="mb-4 text-sm/normal">
              You can complete your order by putting your coupon code into the Promotional code box
              and clicking ‘Apply Coupon’.
            </p>
            <p className="mb-4 text-sm/normal">
                  ...
                  <div key={idx} className="card mb-1.5 shadow-none border dark:border-gray-700">
                    <div className="p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <div className="h-12 w-12">
                            <span className="inline-flex items-center justify-center w-full h-full bg-primary/20 text-primary rounded">
            ...
            <div className="mt-5">
              ...
              <Link
                to=""
                className="btn bg-secondary/20 hover:bg-secondary/40 text-gray-800 dark:text-gray-200"
              >
