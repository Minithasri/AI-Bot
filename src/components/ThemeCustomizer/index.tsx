...
const ThemeCustomizer = ({ handleRightSideBar, rightBarNodeRef }: ThemeCustomizerProps) => {
  ...
  return (
    <>
      <div
        ref={rightBarNodeRef}
        className="h-[70px] flex items-center text-white bg-primary px-6 gap-3"
      >
      ...
      <div className="h-16 p-4 flex items-center gap-4 border-t border-gray-300 dark:border-gray-600 px-6">
        <button
          type="button"
          className="btn bg-primary text-white w-1/2"
          id="reset-layout"
          onClick={() => reset()}
        >
          Reset
        ...
        <button
          type="button"
          className="btn bg-light text-dark dark:text-light dark:bg-opacity-10 w-1/2"
        >
          Buy Now
        </button>
      </div>
