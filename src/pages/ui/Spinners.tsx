  ...
  return (
    <div className="card">
      <div className="p-6">
        ...
        <div className="pt-5">
          <div
            className="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-secondary rounded-full"
            role="status"
            aria-label="loading"
          >
          ...
          <div className="flex flex-wrap gap-6">
            {(colors || []).map((color, idx) => {
              return (
                <div
                  key={idx}
                  className={`animate-spin w-8 h-8 border-[3px] border-current border-t-transparent ${color} rounded-full`}
                  role="status"
                  aria-label="loading"
                >
                  <span className="sr-only">Loading...</span>
          ...
          <div className="flex flex-wrap gap-10">
            {(colors || []).map((color, idx) => (
              <div key={idx} className="h-5 w-5">
                <span
                  className={`animate-ping inline-flex h-full w-full rounded-full ${color}`}
                ></span>
              </div>
            ))}
          </div>
        ...
        <div className="pt-5">
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="flex items-center gap-12">
              <div
                className="animate-spin w-24 h-24 border-[3px] border-current border-t-transparent text-primary rounded-full"
                role="status"
                aria-label="loading"
              >
                <span className="sr-only">Loading...</span>
            ...
            <div className="flex items-center gap-12">
              <div
                className="animate-spin w-20 h-20 border-[3px] border-current border-t-transparent text-primary rounded-full"
                role="status"
                aria-label="loading"
              >
                <span className="sr-only">Loading...</span>
            ...
            <div className="flex items-center gap-12">
              <div
                className="animate-spin w-14 h-14 border-[3px] border-current border-t-transparent text-primary rounded-full"
                role="status"
                aria-label="loading"
              >
                <span className="sr-only">Loading...</span>
            ...
            <div className="flex items-center gap-12">
              <div
                className="animate-spin w-5 h-5 border-[3px] border-current border-t-transparent text-primary rounded-full"
                role="status"
                aria-label="loading"
              >
                <span className="sr-only">Loading...</span>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="flex items-center gap-4">
              <button type="button" className="btn bg-primary/60 text-white cursor-default">
                <div
                  className="animate-spin w-5 h-5 border-[3px] border-current border-t-transparent text-white rounded-full"
                  role="status"
                  aria-label="loading"
                >
                  <span className="sr-only">Loading...</span>
